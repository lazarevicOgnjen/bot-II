...
image2_path = 'cs-oopj-nova-obavestenja.png'

WEBHOOK_URL = [os.getenv('WEBHOOK_OOPJ')]
for url in WEBHOOK_URL:
    ...
    embed.set_image(url="attachment://cs-oopj-nova-obavestenja.png")
    file = File(image2_path, name="cs-oopj-nova-obavestenja.png")
